...
<?php endforeach; ?>
    ...
    <div class="container">
        ...
        <form action="buscar_cliente.php" method="POST" class="form-busca">
            <label for="busca">Digite o ID ou NOME do Cliente (Opcional)</label>
            <input type="text" id="busca" name="busca" oninput="validarBusca(this)" placeholder="Digite para buscar...">
            ...
            <table border="1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="excluir_cliente.php?id=<?=htmlspecialchars($cliente['id_cliente'])?>" onclick="return confirm('Tem certeza que você quer excluir este cliente?')">Excluir</a>
                    </td>
                </tr>
