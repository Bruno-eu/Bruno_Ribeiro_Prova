...
//indica variavel para armazenar clientes
$clientes = [];

//busca todos os clientes cadastro em ordem alfabetica
    ...
    <?php if(!empty($clientes)):?>    
        ...
        <?php foreach($clientes as $cliente): ?>
            <tr>
                ...
                <td>
                    <a href="principal.php?id=<?=htmlspecialchars($cliente['id_cliente'])?>" onclick="return confirm('Tem Certeza que deseja excluir este cliente')">Excluir</a>
                </td>
            </tr>
        <?php endforeach; ?>
        </table>
